...
class ModelLocalisationLanguage extends Model {
	...
	public function deleteLanguage($language_id) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "banner_image_description ");
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "return_action ");
		
		$this->cache->delete('return_action');
		
		$this->db->query("DELETE FROM " . DB_PREFIX . "return_reason");
		
		$this->cache->delete('return_reason');
				
		$this->db->query("DELETE FROM " . DB_PREFIX . "return_status ");
		
		$this->cache->delete('return_status');
								
		$this->db->query("DELETE FROM " . DB_PREFIX . "stock_status ");
		
		$this->cache->delete('stock_status');
		
		$this->db->query("DELETE FROM " . DB_PREFIX . "voucher_theme_description ");
		
		$this->cache->delete('voucher_theme');
				
		$this->db->query("DELETE FROM " . DB_PREFIX . "weight_class_description");
