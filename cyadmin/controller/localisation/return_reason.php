...
class ControllerLocalisationReturnReason extends Controller { 
	private $error = array();
  	...
  	private function getList() {
		...
		$this->template = 'localisation/return_reason_list.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
  	...
  	private function getForm() {
		...
		$this->template = 'localisation/return_reason_form.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
	...
	private function validateForm() {
		...
		if ((utf8_strlen($this->request->post['return_reason']) < 3) || (utf8_strlen($this->request->post['return_reason']) > 32)) {
