...
class ControllerLocalisationOrderStatus extends Controller { 
	private $error = array();
  	...
  	private function getList() {
        ...
        $this->data['refresh'] = $this->url->link('localisation/order_status', 'token=' . $this->session->data['token'] . $url, 'SSL');		
		...
		$this->template = 'localisation/order_status_list.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
  	...
  	private function getForm() {
		...
		$this->template = 'localisation/order_status_form.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
	...
	private function validateForm() {
		...
		$value=$this->request->post['order_status'];
