...
class ControllerLocalisationReturnAction extends Controller { 
	private $error = array();
  	...
  	private function getList() {
		...
		$this->template = 'localisation/return_action_list.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
  	...
  	private function getForm() {
		...
		$this->template = 'localisation/return_action_form.html';
		/*$this->children = array(
			'common/header',
			'common/footer'
		);*/
	...
	private function validateForm() {
		...
		if ((utf8_strlen($this->request->post['return_action']) < 3) || (utf8_strlen($this->request->post['return_action']) > 32)) {
