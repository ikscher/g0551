...
class ControllerCatalogInformation extends Controller { 
	...
	private function getList() {
        ...
        $this->data['refresh'] = $this->url->link('catalog/information', 'token=' . $this->session->data['token'], 'SSL');	
		...
		$this->template = 'catalog/information_list.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
	...
	private function getForm() {
		...
		$this->template = 'catalog/information_form.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
	...
	private function validateForm() {
		...
		if ((utf8_strlen($information_description['title']) < 3) || (utf8_strlen($information_description['title']) > 64)) {
			$this->error['title'] = $this->language->get('error_title');
		}
	
		if (utf8_strlen($information_description['description'])< 3) {
