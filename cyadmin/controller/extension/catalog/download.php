...
class ControllerCatalogDownload extends Controller {  
	private $error = array();
  	...
  	private function getList() {
        ...
        $this->data['refresh'] = $this->url->link('catalog/download', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->template = 'catalog/download_list.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
  	...
  	private function getForm() {
		...
		$this->template = 'catalog/download_form.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
  	...
  	private function validateForm() { 
		...
		if ((utf8_strlen($download_description) < 3) || (utf8_strlen($download_description) > 64)) {
