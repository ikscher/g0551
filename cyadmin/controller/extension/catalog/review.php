...
class ControllerCatalogReview extends Controller {
	...
	private function getList() {
        ...
        $this->data['refresh'] = $this->url->link('catalog/review', 'token=' . $this->session->data['token'] , 'SSL');	
		...
		$this->template = 'catalog/review_list.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
	...
	private function getForm() {
		...
		$this->template = 'catalog/review_form.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
