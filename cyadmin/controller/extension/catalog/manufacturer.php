	...
	private $error = array();
  	...
  	public function update() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect($this->url->link('catalog/manufacturer/update', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
  	...
  	private function getList() {
        ...
        $this->data['refresh'] = $this->url->link('catalog/manufacturer', 'token=' . $this->session->data['token'], 'SSL');	
		...
		$this->template = 'catalog/manufacturer_list.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
  	...
  	private function getForm() {
		...
		$this->template = 'catalog/manufacturer_form.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
