...
/*首页加载*/
	public function index() {
		...
		*/
		...
		$this->data['total_sale'] = number_format($this->model_sale_order->getTotalSales(),2,'.',',');
		$this->data['total_sale_year'] = number_format($this->model_sale_order->getTotalSalesByYear(date('Y')),2,'.',',');
		...
		$this->template = 'common/home.html';
		$this->children = array(
			'common/header',
			'common/footer'
		);
