...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_user_action'] = $this->language->get('text_user_action');
		...
		$this->data['text_show_comments'] = $this->language->get('text_show_comments');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['category_to_attribute_group']=$this->url->link('catalog/category_to_attribute_group', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['show_contents'] = $this->url->link('show/contents', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['show_comments'] = $this->url->link('show/comments', 'token=' . $this->session->data['token'], 'SSL');
			
			$this->data['userid']=$this->cookie->OCAuthCode($this->request->cookie['adminuserid'],'DECODE');
			$this->data['username']=$this->cookie->OCAuthCode($this->request->cookie['adminusername'],'DECODE');
			$this->data['home']=HTTP_CATALOG;
		...
		$this->template = 'common/header.html';
