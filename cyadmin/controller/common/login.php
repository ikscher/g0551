...
class ControllerCommonLogin extends Controller { 
	...
	public function index() { 
		...
		if ($this->user->isLogged() && isset($this->request->get['token']) && (isset($this->request->get['token'])?$this->request->get['token']:'' == $this->session->data['token'])) {
		...
		$this->template = 'common/login.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
