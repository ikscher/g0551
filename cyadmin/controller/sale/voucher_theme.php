...
class ControllerSaleVoucherTheme extends Controller { 
	private $error = array();
  	...
  	private function getList() {
		...
		$this->template = 'sale/voucher_theme_list.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
  	...
  	private function getForm() {
		...
		if (isset($this->request->post['voucher_theme_description'])) {
			...
			$this->data['voucher_theme_description'] = '';
		}
		...
		$this->template = 'sale/voucher_theme_form.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
	...
	private function validateForm() {
    	...
    	$v=$this->request->post['voucher_theme_description'];
		if ((utf8_strlen($v) < 3) || (utf8_strlen($v) > 32)) {
