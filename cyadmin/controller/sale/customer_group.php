...
class ControllerSaleCustomerGroup extends Controller {
	...
	private function getList() {
		...
		$this->data['refresh'] = $this->url->link('sale/customer_group', 'token=' . $this->session->data['token'] . $url, 'SSL');					
		...
		$this->template = 'sale/customer_group_list.html';
	...
	private function getForm() {
		...
		$this->template = 'sale/customer_group_form.html';
		/* $this->children = array(
			'common/header',
			'common/footer'
		); */
	...
	private function validateForm() {
		...
		$value=$this->request->post['customer_group_description'];
	...
	public function validateDelete() {
		...
		// $this->response->setOutput(json_encode($this->request->post['s']));exit;
		foreach ($this->request->post['s'] as $customer_group_id) {
			...
			if ($customer_total) {
				$error[] = sprintf($this->language->get('error_member'), $customer_total);
			}
