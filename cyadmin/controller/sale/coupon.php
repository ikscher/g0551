...
class ControllerSaleCoupon extends Controller {
	private $error = array();
  	...
  	private function getList() {
    	...
    	foreach ($results as $result) {
			...
			$this->data['coupons'][] = array(
				...
				'date_start' => date('Y-m-d', $result['date_start']),
				'date_end'   => date('Y-m-d', $result['date_end']),
		...
		$this->template = 'sale/coupon_list.html';
		/* $this->children = array(
			'common/header',	
			'common/footer'	
		); */
  	...
  	private function getForm() {
		...
		$this->data['entry_uses_customer'] = $this->language->get('entry_uses_member');
		...
		if (isset($this->request->post['date_start'])) {
			...
			$this->data['date_start'] = date('Y-m-d', $coupon_info['date_start']);
		} else {
		...
		if (isset($this->request->post['date_end'])) {
			...
			$this->data['date_end'] = date('Y-m-d', $coupon_info['date_end']);
		} else {
		...
		$this->template = 'sale/coupon_form.html';
		/* $this->children = array(
			'common/header',	
			'common/footer'	
		); */
	...
	public function history() {
		...
		$this->template = 'sale/coupon_history.html';		
