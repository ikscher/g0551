...
class ControllerSaleCustomer extends Controller { 
	private $error = array();
  	...
  	private function getList() {
		...
		$this->data['refresh'] = $this->url->link('sale/customer', 'token=' . $this->session->data['token'] , 'SSL');
		...
		$this->data['column_customer_group'] = $this->language->get('column_member_group');
		...
		$this->template = 'sale/customer_list.html';
  	...
  	private function getForm() {
		...
		if (isset($this->error['address_username'])) {
			$this->data['error_address_username'] = $this->error['address_username'];
		} else {
			$this->data['error_address_username'] = '';
		}
		...
		$this->template = 'sale/customer_form.html';
  	...
  	private function validateForm() {
		...
		/* if (isset($this->request->post['address'])) {
			foreach ($this->request->post['address'] as $key => $value) {
				if ((utf8_strlen($value['username']) < 2) || (utf8_strlen($value['username']) > 32)) {
					$this->error['address_username'][$key] = $this->language->get('error_username');
				}
	...
	public function transaction() {
		...
		$this->template = 'sale/customer_transaction.html';		
	...
	public function reward() {
		...
		$this->template = 'sale/customer_reward.html';		
