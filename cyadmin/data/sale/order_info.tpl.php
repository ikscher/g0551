    ...
    <div class="list-div" id="listDiv">
      ...
      <div id="tab-order" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            ...
            <td><a href="<?php echo $customer;?>"><?php echo $username;?> <?php echo $username;?></a></td>
          </tr>
         ...
         <?php } ?>
          ...
          <tr>
            ...
            <td><a href="<?php echo $affiliate;?>"><?php echo $affiliate_username;?> <?php echo $affiliate_username;?></a></td>
          </tr>
          <tr>
      ...
      <div id="tab-payment" class="vtabs-content">
        <table class="form">
          <tr>
            ...
            <td><?php echo $payment_username;?></td>
          </tr>
      ...
      <div id="tab-shipping" class="vtabs-content">
        <table class="form">
          <tr>
            <td><?php echo $text_username;?></td>
            <td><?php echo $shipping_username;?></td>
          </tr>
     ...
     <?php } ?>
      <div id="tab-product" class="vtabs-content">
        <table class="list">
          ...
          <?php foreach((array)$totals as $totals) {?>
          <tbody id="totals">
            <tr>
        ...
        <table class="form">
          <tr>
            ...
            <td><select name="order_status_id">
                <?php foreach((array)$order_statuses as $order_statuses) {?>
          ...
          <tr>
            ...
            <td><textarea name="comment" cols="40" rows="8" style="width: 99%"></textarea>
              <div style="margin-top: 10px; text-align: right;"><a  href="javascript:;" id="button-history" class="button"><?php echo $button_add_history;?></a></div></td>
          </tr>
        </table>
      </div>
      <?php if($maxmind_id) { ?>
...
$('#button-history').live('click', function() {
	$.ajax({
		...
		type: 'post',
		dataType: 'html',
		data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&notify=' + encodeURIComponent($('input[name=\'notify\']').prop('checked') ? 1 : 0) + '&append=' + encodeURIComponent($('input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()),
		beforeSend: function() {
			$('.success, .warning').remove();
