...
$_['entry_category']      = '&nbsp;&nbsp;&nbsp;商品分类：<br /><span class="help">选择商品分类下的所有商品。</span>';
...
$_['entry_uses_member'] = '&nbsp;&nbsp;&nbsp;每个客户可以使用次数：<br /><span class="help">每个客户可使用优惠券的最大次数，空白既无限制</span>';
$_['entry_status']        = '&nbsp;&nbsp;&nbsp;状态：';

// Error
$_['error_permission']    = '警告： 您没有权限更改优惠券设置！';
$_['error_exists']        = '警告：优惠券已经使用！';
$_['error_name']          = '优惠券名称必须在3至64个字符之间！';
