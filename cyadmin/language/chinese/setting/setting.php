...
// Entry
$_['entry_name']                 = '注册名称：';
$_['entry_short_name']           = '商店名称：';//---------------------------
$_['entry_username']             = '用户名：'; //-----------------------------
/*-------------------------------------------------------------------------*/
$_['entry_password']                  = '密码：';
$_['entry_map_x']                     = '经度：';
$_['entry_map_y']                     = '纬度：';
$_['entry_mark_quality']              = '正品保障：';
$_['entry_mark_invoice']              = '提供发票：';
$_['entry_mark_replace']              = '退换服务：';
$_['entry_mark_money']                = '店铺保证金：';
/*-------------------------------------------------------------------------*/
$_['entry_owner']                = '商店拥有者：';
...
$_['entry_tax_member']         = '使用客户所在地税率：<br /><span class="help">注册客户使用客户所在地税率。 你可以使用商店所在地税率计算税费。</span>';
...
$_['entry_member_group']       = '客户组：<br /><span class="help">默认客户组。</span>';
$_['entry_member_price']       = '登入显示价格：<br /><span class="help">会员登入后，才能显示价格。</span>';
$_['entry_member_approval']    = '审核新客户：<br /><span class="help">新注册用户是否需要审核才能登入。</span>';
$_['entry_guest_checkout']       = '游客结帐：<br /><span class="help">允许未注册用户直接结账，此项交易不适用于可下载的产品。</span>';
$_['entry_account']              = '账户条款：<br /><span class="help">注册帐户前必须同意的条款。</span>';
$_['entry_checkout']             = '结帐条款：<br /><span class="help">结帐前用户必须同意的条款。</span>';
