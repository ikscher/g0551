...
$_['column_category']            = '类别';
$_['column_sub_category']        = '包含子类';
$_['column_status']              = '状态';
$_['column_action']              = '管理';
...
$_['entry_store']                = '&nbsp;&nbsp;所属网店：';
$_['entry_keyword']              = '&nbsp;&nbsp;SEO关键字：<span class="help">请不要使用空格键，SEO关键字必须是维一的。</span>';
$_['entry_model']                = '&nbsp;&nbsp;商品型号：';
$_['entry_sku']                  = '&nbsp;&nbsp;库存单位：';
$_['entry_upc']                  = '&nbsp;&nbsp;UPC：';
...
$_['entry_minimum']              = '&nbsp;&nbsp;最小起订量：<span class="help">最小订单数据</span>';
$_['entry_stock_status']         = '&nbsp;&nbsp;库存状况：<span class="help">显示当一个产品没有存货时的状态</span>';
$_['entry_price']                = '&nbsp;&nbsp;销售价格：';
$_['entry_tax_class']            = '&nbsp;&nbsp;商品税类：';
$_['entry_points']               = '积分：<span class="help">购买此商品所需积分。如果您不想让客户使用积分来购买此产品，请将值设为0。</span>';
...
$_['entry_tag']          	 = '产品标签：<span class="help">使用逗号分开</span>';
$_['entry_reward']               = '积分：';
$_['entry_layout']               = '布局覆盖：';
