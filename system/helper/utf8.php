...
Add these functions  formatSerialize and formatSerializeRev:
*/
 ...
 */
    ...
    function sendMail($subject,$address,$body){
        ...
        //require_once '../library/class.phpmailer.php'; //载入PHPMailer类 
