...
KindEditor.plugin('multiimage', function(K) {
	var self = this, name = 'multiimage',
		...
		uploadJson2 = uploadJson,
		imgPath = self.pluginsPath + 'multiimage/images/',
		imageSizeLimit = K.undef(self.imageSizeLimit, '512KB'),
		imageSizeLimit2 = imageSizeLimit,
		imageFileTypes = K.undef(self.imageFileTypes, '*.jpg;*.gif;*.png'),
		imageUploadLimit = K.undef(self.imageUploadLimit, 10),
		imageUploadLimit2 = imageUploadLimit,
		filePostName = K.undef(self.filePostName, 'imgFile'),
		lang = self.lang(name + '.');

	self.plugin.multiImageDialog = function(options) {
		uploadJson2=K.undef(options.uploadJson, uploadJson2);
		imageUploadLimit=K.undef(options.imageUploadLimit, imageUploadLimit2);
		imageSizeLimit=K.undef(options.imageSizeLimit, imageSizeLimit2);
