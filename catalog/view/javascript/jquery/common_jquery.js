...
$(document).ready(function(){
		...
		$(".clist_week_ranking_con dl dd").hover(function(){
			clista=$(this).parent().children("dd");
			var index=$.inArray(this,clista);	
		...
		$(".clothes_focus_img ul li").click(function(){
			...
			cshco=$(".clothes_show").children("img");
