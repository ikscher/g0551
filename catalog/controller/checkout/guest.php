...
class ControllerCheckoutGuest extends Controller {
  	public function index() {
		...
		if (isset($this->session->data['guest']['telphone'])) {
			$this->data['telphone'] = $this->session->data['guest']['telphone'];		
		} else {
			$this->data['telphone'] = '';
		}
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/guest.html')) {
			$this->template = $this->config->get('config_template') . '/template/checkout/guest.html';
		} else {
			$this->template = 'default/template/checkout/guest.html';
		}
	...
	public function validate() {
		...
		if (!$json) {
			...
			$this->session->data['guest']['telphone'] = $this->request->post['telphone'];
