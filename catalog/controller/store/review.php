<?php
	...
	class ControllerStoreReview extends Controller 
    {
        ...
        {		
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/store/review.html')) {
				$this->template = $this->config->get('config_template') . '/template/store/review.html';
			} else {
				$this->template = 'default/template/store/review.html';
			}			
