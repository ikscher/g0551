...
class ControllerAffiliatePassword extends Controller {
	private $error = array();
  	...
  	public function index() {	
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/password.html')) {
			$this->template = $this->config->get('config_template') . '/template/affiliate/password.html';
		} else {
			$this->template = 'default/template/affiliate/password.html';
		}
