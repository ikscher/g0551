...
class ControllerAffiliatePayment extends Controller {
	...
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/payment.html')) {
			$this->template = $this->config->get('config_template') . '/template/affiliate/payment.html';
		} else {
			$this->template = 'default/template/affiliate/payment.html';
		}
