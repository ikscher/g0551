...
class ControllerAffiliateTracking extends Controller { 
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/tracking.html')) {
			$this->template = $this->config->get('config_template') . '/template/affiliate/tracking.html';
		} else {
			$this->template = 'default/template/affiliate/tracking.html';
		}
