...
class ControllerAffiliateRegister extends Controller {
	private $error = array();
  	...
  	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/register.html')) {
			$this->template = $this->config->get('config_template') . '/template/affiliate/register.html';
		} else {
			$this->template = 'default/template/affiliate/register.html';
		}
