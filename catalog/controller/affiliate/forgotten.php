...
class ControllerAffiliateForgotten extends Controller {
	...
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/forgotten.html')) {
			$this->template = $this->config->get('config_template') . '/template/affiliate/forgotten.html';
		} else {
			$this->template = 'default/template/affiliate/forgotten.html';
		}
