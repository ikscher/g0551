...
class ControllerAffiliateEdit extends Controller {
	...
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/edit.html')) {
			$this->template = $this->config->get('config_template') . '/template/affiliate/edit.html';
		} else {
			$this->template = 'default/template/affiliate/edit.html';
		}
