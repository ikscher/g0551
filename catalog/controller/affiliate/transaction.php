...
class ControllerAffiliateTransaction extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/transaction.html')) {
			$this->template = $this->config->get('config_template') . '/template/affiliate/transaction.html';
		} else {
			$this->template = 'default/template/affiliate/transaction.html';
		}
