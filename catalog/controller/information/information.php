...
class ControllerInformationInformation extends Controller {
	public function index() {  
		...
		if ($information_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/information.html')) {
				$this->template = $this->config->get('config_template') . '/template/information/information.html';
			} else {
				$this->template = 'default/template/information/information.html';
			}
