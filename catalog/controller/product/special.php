...
class ControllerProductSpecial extends Controller { 	
	public function index() { 
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/special.html')) {
			$this->template = $this->config->get('config_template') . '/template/product/special.html';
		} else {
			$this->template = 'default/template/product/special.html';
		}
