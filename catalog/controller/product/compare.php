...
class ControllerProductCompare extends Controller {
	public function index() { 
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/compare.html')) {
			$this->template = $this->config->get('config_template') . '/template/product/compare.html';
		} else {
			$this->template = 'default/template/product/compare.html';
		}
