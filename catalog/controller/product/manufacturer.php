...
class ControllerProductManufacturer extends Controller {  
	public function index() { 
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/manufacturer_list.html')) {
			$this->template = $this->config->get('config_template') . '/template/product/manufacturer_list.html';
		} else {
			$this->template = 'default/template/product/manufacturer_list.html';
		}			
	...
	public function info() {
		...
		if ($manufacturer_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/manufacturer_info.html')) {
				$this->template = $this->config->get('config_template') . '/template/product/manufacturer_info.html';
			} else {
				$this->template = 'default/template/product/manufacturer_info.html';
			}
