...
class ControllerModuleAffiliate extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/affiliate.html')) {
			$this->template = $this->config->get('config_template') . '/template/module/affiliate.html';
		} else {
			$this->template = 'default/template/module/affiliate.html';
		}
