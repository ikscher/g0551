...
class ControllerModuleGoogleTalk extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/google_talk.html')) {
			$this->template = $this->config->get('config_template') . '/template/module/google_talk.html';
		} else {
			$this->template = 'default/template/module/google_talk.html';
		}
