...
class ControllerModuleCart extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/cart.html')) {
			$this->template = $this->config->get('config_template') . '/template/module/cart.html';
		} else {
			$this->template = 'default/template/module/cart.html';
		}
