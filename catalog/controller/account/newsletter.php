...
class ControllerAccountNewsletter extends Controller {  
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/newsletter.html')) {
			$this->template = $this->config->get('config_template') . '/template/account/newsletter.html';
		} else {
			$this->template = 'default/template/account/newsletter.html';
		}
