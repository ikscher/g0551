...
class ControllerAccountDownload extends Controller {
	public function index() {
		...
		if ($download_total) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/download.html')) {
				$this->template = $this->config->get('config_template') . '/template/account/download.html';
			} else {
				$this->template = 'default/template/account/download.html';
			}
