...
class ControllerAccountReward extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/reward.html')) {
			$this->template = $this->config->get('config_template') . '/template/account/reward.html';
		} else {
			$this->template = 'default/template/account/reward.html';
		}
