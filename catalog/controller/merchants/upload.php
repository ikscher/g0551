<?php 
//include_once "system/library/json.php";
class ControllerMerchantsUpload extends Controller { 
	public function index() {
    	...
    	if (!$customer_id) {
			...
			$this->showMessage("您还没登录已超时，请重新登录！");
		...
		//文件保存目录路径
		//$save_path = DIR_IMAGE."/data/";
		//$save_url = $server."/data/";
		$save_path = DIR_IMAGE."/data/";
		$save_url = "image/data/";
		//文件保存目录URL
		...
		if (empty($_FILES) === false) {
			...
			$save_path .= $dirYear ."/".$dirMonth . "/".$dirDay."/";
			$save_url .= $dirYear ."/".$dirMonth . "/".$dirDay."/";
