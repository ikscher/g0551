...
class ControllerMerchantsFooter extends Controller {
	...
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/merchants/footer.html')) {
			$this->template = $this->config->get('config_template') . '/template/merchants/footer.html';
		} else {
			$this->template = 'default/template/merchants/footer.html';
		}
