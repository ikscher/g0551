...
class ControllerPaymentAuthorizeNetSim extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/authorizenet_sim_index.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/authorizenet_sim_index.html';
		} else {
			$this->template = 'default/template/payment/authorizenet_sim_index.html';
		}	
	...
	public function callback() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/authorizenet_sim_callback.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/authorizenet_sim_callback.html';
		} else {
			$this->template = 'default/template/payment/authorizenet_sim_callback.html';
		}	
