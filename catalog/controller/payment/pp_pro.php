...
class ControllerPaymentPPPro extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/pp_pro.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/pp_pro.html';
		} else {
			$this->template = 'default/template/payment/pp_pro.html';
		}	
