...
class ControllerPaymentNochex extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/nochex.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/nochex.html';
		} else {
			$this->template = 'default/template/payment/nochex.html';
		}	
