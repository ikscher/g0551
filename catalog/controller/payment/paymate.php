...
class ControllerPaymentPaymate extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/paymate.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/paymate.html';
		} else {
			$this->template = 'default/template/payment/paymate.html';
		}	
