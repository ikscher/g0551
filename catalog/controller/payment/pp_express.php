...
class ControllerPaymentPPExpress extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/pp_express.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/pp_express.html';
		} else {
			$this->template = 'default/template/payment/pp_express.html';
		}	
