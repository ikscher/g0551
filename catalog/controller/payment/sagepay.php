...
class ControllerPaymentSagepay extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/sagepay.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/sagepay.html';
		} else {
			$this->template = 'default/template/payment/sagepay.html';
		}	
