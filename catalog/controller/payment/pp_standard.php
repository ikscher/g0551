...
class ControllerPaymentPPStandard extends Controller {
	protected function index() {
		...
		if ($order_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/pp_standard.html')) {
				$this->template = $this->config->get('config_template') . '/template/payment/pp_standard.html';
			} else {
				$this->template = 'default/template/payment/pp_standard.html';
			}
