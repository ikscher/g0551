...
class ControllerPaymentPayza extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payza.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payza.html';
		} else {
			$this->template = 'default/template/payment/payza.html';
		}		
