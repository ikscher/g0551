...
class ControllerPaymentGoogleCheckout extends Controller {
	public function index() {
		...
		if ($order_info) {		
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/google_checkout.html')) {
				$this->template = $this->config->get('config_template') . '/template/payment/google_checkout.html';
			} else {
				$this->template = 'default/template/payment/google_checkout.html';
			}	
