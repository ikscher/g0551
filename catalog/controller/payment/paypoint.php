...
class ControllerPaymentPaypoint extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/paypoint.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/paypoint.html';
		} else {
			$this->template = 'default/template/payment/paypoint.html';
		}
	...
	public function callback() {
		...
		if ($order_info) {
			...
			if (isset($this->request->get['code']) && $this->request->get['code'] == 'A' && $status) {
				...
				if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/paypoint_success.html')) {
					$this->template = $this->config->get('config_template') . '/template/payment/paypoint_success.html';
				} else {
					$this->template = 'default/template/payment/paypoint_success.html';
				}
				...
				if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/paypoint_failure.html')) {
					$this->template = $this->config->get('config_template') . '/template/payment/paypoint_failure.html';
				} else {
					$this->template = 'default/template/payment/paypoint_failure.html';
				}
