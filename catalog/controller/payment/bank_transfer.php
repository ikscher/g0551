...
class ControllerPaymentBankTransfer extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/bank_transfer.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/bank_transfer.html';
		} else {
			$this->template = 'default/template/payment/bank_transfer.html';
		}	
