...
class ControllerPaymentKlarnaPP extends Controller {
	protected function index() {
		...
		if ($order_info) {
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/klarna_invoice.html')) {
				$this->template = $this->config->get('config_template') . '/template/payment/klarna_invoice.html';
			} else {
				$this->template = 'default/template/payment/klarna_invoice.html';
			}
