...
class ControllerPaymentSagepayUS extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/sagepay_us.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/sagepay_us.html';
		} else {
			$this->template = 'default/template/payment/sagepay_us.html';
		}	
