...
class ControllerPaymentTwoCheckout extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/twocheckout.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/twocheckout.html';
		} else {
			$this->template = 'default/template/payment/twocheckout.html';
		}	
