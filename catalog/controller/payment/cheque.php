...
class ControllerPaymentCheque extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/cheque.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/cheque.html';
		} else {
			$this->template = 'default/template/payment/cheque.html';
		}	
