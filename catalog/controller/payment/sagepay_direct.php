...
class ControllerPaymentSagepayDirect extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/sagepay_direct.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/sagepay_direct.html';
		} else {
			$this->template = 'default/template/payment/sagepay_direct.html';
		}	
