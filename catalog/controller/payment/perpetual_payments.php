...
class ControllerPaymentPerpetualPayments extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/perpetual_payments.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/perpetual_payments.html';
		} else {
			$this->template = 'default/template/payment/perpetual_payments.html';
		}	
