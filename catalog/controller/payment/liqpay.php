...
class ControllerPaymentLiqPay extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/liqpay.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/liqpay.html';
		} else {
			$this->template = 'default/template/payment/liqpay.html';
		}	
