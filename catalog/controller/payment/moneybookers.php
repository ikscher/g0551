...
class ControllerPaymentMoneybookers extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/moneybookers.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/moneybookers.html';
		} else {
			$this->template = 'default/template/payment/moneybookers.html';
		}	
