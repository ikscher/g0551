...
class ControllerPaymentAuthorizeNetAim extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/authorizenet_aim.html')) {
			$this->template = $this->config->get('config_template') . '/template/payment/authorizenet_aim.html';
		} else {
			$this->template = 'default/template/payment/authorizenet_aim.html';
		}	
		
		$this->render();		
	}
	
	public function send() { //支付代理商 返回 过来的information
