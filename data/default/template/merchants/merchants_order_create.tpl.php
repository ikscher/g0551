<?php echo $header;?>
	...
	<div class="item-list-hd">
   	<ul class="item-list-tabs item-list-tabs-flexible clearfix" data-spm="9">
	    <li class="current"><a href="index.php?route=merchants/order_create"><?php echo $createorder;?></a></li>
		<li><a href="index.php?route=merchants/order" hidefocus="true"><?php echo $waitingorder;?></a></li>
		...
		<table width="790" height="100" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#e6e6e6" >
		  ...
		  <tr>
			...
			<td bgcolor="#FFFFFF" width="80" align="center">
			  <?php echo $order['order_status'];?><br>
			  <a href="index.php?route=merchants/order/detail&id=<?php echo $order['order_id'];?>" target="_blank" class="txt_color">详情</a>			</td>
			<td bgcolor="#FFFFFF" width="100" align="center">
				<span class="total" data-id="<?php echo $order['order_id'];?>"><?php echo $order['total'];?></span><p class="post-type"><?php if(!empty($order['shipping'])) { ?>(含<?php echo $order['shipping']['title'];?>:<?php echo $order['shipping']['text'];?>)<?php } ?></p>
							    						    			
			</td>
			<td bgcolor="#FFFFFF"><a href="javascript:void(0)"  class="modifyOrderTotal"> <span >修改金额</span></a> <a href="javascript:void(0)" class="deleteOrder"> <span class="delete">删除</span></a></td>
		  </tr>
		</table>
        <?php } ?>
	  </div>
